<div class="form-option agent-fields-wrapper">
	...
	<div class="agent-options">
		...
		if ( !empty( $profile_url ) ) {
			?><small><a href="<?php echo esc_url( $profile_url ); ?>" target="_blank"><?php _e('( Edit Profile Information )', 'framework'); ?></a></small><?php
		} else {
			?><small><a href="<?php echo network_admin_url( 'profile.php' ); ?>" target="_blank"><?php _e('( Edit Profile Information )', 'framework'); ?></a></small><?php
		}
		?>
		<br/>
