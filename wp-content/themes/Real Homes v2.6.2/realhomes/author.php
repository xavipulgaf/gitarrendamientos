                ...
                <div class="main">
                    ...
                    <section class="listing-layout">
                        ...
                        if( !empty( $current_author->display_name ) ) { ?>
                            <h3 class="title-heading"><?php echo esc_html( $current_author->display_name ); ?></h3>
                        <?php } ?>
                                            ...
                                            if( isset( $current_author_meta['mobile_number'] ) || isset( $current_author_meta['office_number'] ) || isset( $current_author_meta['fax_number'] ) ){
                                                ...
                                                <ul class="contacts-list">
                                                    ...
                                                    if(!empty( $current_author_meta['office_number'][0] )){
                                                        ?><li class="office"><?php include( get_template_directory() . '/images/icon-phone.svg' ); _e('Office', 'framework'); ?> : <?php echo esc_html( $current_author_meta['office_number'][0] ); ?></li><?php
                                                    }

                                                    if( !empty( $current_author_meta['mobile_number'][0] ) ){
                                                        ?><li class="mobile"><?php include( get_template_directory() . '/images/icon-mobile.svg' ); _e('Mobile', 'framework'); ?> : <?php echo esc_html( $current_author_meta['mobile_number'][0] ); ?></li><?php
                                                    }

                                                    if( !empty( $current_author_meta['fax_number'][0] ) ){
                                                        ?><li class="fax"><?php include( get_template_directory() . '/images/icon-printer.svg' ); _e('Fax', 'framework'); ?>  : <?php echo esc_html( $current_author_meta['fax_number'][0] ); ?></li><?php
                                                    }
                                                    ?>
                                                </ul>
                                            <?php
