	...
	function houzez_invoice_meta( $object, $box ) {
		...
		<div class="favethemes_meta_control">
			...
			<div class="fave-inline-block-wrap">
				...
				<input class="fave-input-text-backend-small" type="text" name="fave[invoice_billion_for]" value="<?php echo esc_attr($fave_meta['invoice_billion_for']); ?>" /> <br/>
		...
		<div class="favethemes_meta_control">
			...
			<div class="fave-inline-block-wrap">
				...
				<input class="fave-input-text-backend-small" type="text" name="fave[invoice_billing_type]" value="<?php echo esc_html($fave_meta['invoice_billing_type']); ?>" />
			</div>
		</div>
		...
		<div class="favethemes_meta_control">
			...
			<div class="fave-inline-block-wrap">
				...
				<input class="fave-input-text-backend-small" type="text" name="fave[invoice_payment_method]" value="<?php echo esc_html($fave_meta['invoice_payment_method']); ?>" />
			</div>
		</div>
