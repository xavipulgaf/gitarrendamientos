...
if (class_exists('WPBakeryVisualComposer')) {
	...
	add_action( 'admin_init', 'houzez_vc_remove_element' );

	if ( !function_exists( 'houzez_vc_remove_element' ) ) {

		function houzez_vc_remove_element() {
	...
	vc_map( array(
		...
		"params"				=> array(
			...
			array(
				...
				"type" => "dropdown",
				"value" => array( 'Property Types' => 'property_type', 'Property City' => 'property_city', 'Property Labels' => 'property_label', 'Property State/County' => 'property_state', 'Property Neighborhood' => 'property_area' ),
			...
			array(
				"param_name" => "property_label_exc",
				"type" => "checkbox",
				"value" => houzez_get_property_label_id_array(false),
				"heading" => esc_html__("Exclude Labels:", "houzez"),
				"description" => "",
				"save_always" => true,
			...
			array(
				...
				"type" => "checkbox",
				"value" => houzez_get_property_state_id_array(false),
	...
	vc_map(array(
		...
		"params" => array(
			...
			array(
				...
				"type" => "dropdown",
				"value" => houzez_get_property_state_slug_array(),
			...
			array(
				...
				"type" => "dropdown",
				"value" => houzez_get_property_label_slug_array(),
