	...
	function houzez_get_localization() {
		...
		$localization = array(
			...
			*------------------------------------------------------*/
			...
			'all_labels' 		=> esc_html__( 'All Labels', 'houzez' ),
			...
			'auto_result_not_found'		=> esc_html__( 'We didn’t found any results', 'houzez' ),
			...
			'agent_information'	=> esc_html__( 'Contact Information', 'houzez' ),
			'contact_information'	=> esc_html__( 'Contact Information', 'houzez' ),
			'what_display_agentbox'	=> esc_html__( 'What information do you want to display in agent data container?', 'houzez' ),
			'what_display_contactbox'	=> esc_html__( 'What information do you want to display in agent data container?', 'houzez' ),
			'author_info'	=> esc_html__( 'Author Data.', 'houzez' ),
			'agency_info'	=> esc_html__( 'Agency Data.', 'houzez' ),
			'agent_info'	=> esc_html__( 'Agent Data (Choose agent from the list below)', 'houzez' ),
			'hide_info_box'	=> esc_html__( 'Do not display', 'houzez' ),
