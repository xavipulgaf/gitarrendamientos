...
$houzez_tabs_schedule = houzez_option('houzez_tabs_schedule');
...
<div class="detail-content-tabber">
    ...
    <ul class="detail-tabs">
        ...
        if ($layout): foreach ($layout as $key => $value) {
            ...
            if( $i == 0 ) { $li_start = '<li class="active">'; } else { $li_start = '<li>'; }
    ...
    <div class="tab-content">
        ...
        if ($layout): foreach ($layout as $key=>$value) {
            ...
            if( $j == 0 ) { $tab_start = '<div class="tab-pane fade in active">'; } else { $tab_start = '<div class="tab-pane fade">'; }
...
<?php if( $houzez_tabs_schedule != 0 ) { get_template_part( 'property-details/schedule', 'tour' ); } ?>
