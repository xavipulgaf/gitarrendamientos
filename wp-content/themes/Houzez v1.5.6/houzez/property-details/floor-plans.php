        ...
        <?php foreach( $floor_plans as $plan ):
            ...
            <div class="accord-content">
                <?php if( !empty( $plan['fave_plan_image'] ) ) { ?>
                    <a href="<?php echo esc_url( $plan['fave_plan_image'] ); ?>" data-fancy="property_gallery"><img src="<?php echo esc_url( $plan['fave_plan_image'] ); ?>" alt="Floor Plan" width="400" height="436"></a>
                <?php } ?>
