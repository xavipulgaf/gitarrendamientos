				...
				<div class="col-md-4 col-sm-8 col-xs-12">
					<div class="profile-description">
						...
						<ul class="profile-contact">
							<?php if( !empty($current_author_meta['fave_author_license']) ) { ?>
								<li><span><?php echo $houzez_local['licenses']; ?></span> <?php echo esc_attr( $current_author_meta['fave_author_license'] ); ?></li>
							<?php } ?>
							...
							<?php if( !empty($current_author_meta['fave_author_tax_no']) ) { ?>
								<li><span><?php echo $houzez_local['tax_number']; ?> </span> <?php echo esc_attr( $current_author_meta['fave_author_tax_no'] ); ?></li>
							<?php } ?>
