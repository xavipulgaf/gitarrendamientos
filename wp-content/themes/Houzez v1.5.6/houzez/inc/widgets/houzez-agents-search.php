...
class HOUZEZ_agent_search extends WP_Widget {
    ...
    public function __construct() {
        ...
        parent::__construct(
            ...
            array( 'description' => esc_html__( 'Agents Search', 'houzez' ), ) // Args
        );
                ...
                <div class="range-block rang-form-block">
                    <div class="row">
                        <div class="col-sm-12 col-xs-12">
                            <button type="submit" class="btn btn-secondary btn-block"><i class="fa fa-search fa-left"></i><?php echo $houzez_local['search_agent_btn']; ?></button>
                        </div>
                     </div>
                </div>
