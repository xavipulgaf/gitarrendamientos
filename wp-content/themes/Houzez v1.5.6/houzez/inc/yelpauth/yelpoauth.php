...
function yelp_obtain_bearer_token() {
    try {
        ...
        $CLIENT_ID = houzez_option('houzez_yelp_client_id');
        $CLIENT_SECRET = houzez_option('houzez_yelp_client_secret');
 ...
 * 
 * @param    $bearer_token   API bearer token from yelp_obtain_bearer_token
 ...
 * @return   The JSON response from the request 
 */
function yelp_search($bearer_token, $term, $location) {
    $url_params = array();
    ...
    return yelp_request($bearer_token, $GLOBALS['API_HOST'], $GLOBALS['SEARCH_PATH'], $url_params);
}
 ...
 * @return   The JSON response from the request 
 */
function yelp_get_business($bearer_token, $business_id) {
    $business_path = $GLOBALS['BUSINESS_PATH'] . urlencode($business_id);
    
    return yelp_request($bearer_token, $GLOBALS['API_HOST'], $business_path);
}
...
function yelp_query_api($term, $location) {     
    $bearer_token = yelp_obtain_bearer_token();

    $response = json_decode(yelp_search($bearer_token, $term, $location));
    ...
    $response = yelp_get_business($bearer_token, $business_id);
