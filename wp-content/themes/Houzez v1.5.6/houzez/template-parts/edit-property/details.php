...
<div class="account-block <?php echo esc_attr($is_multi_steps);?>">
    ...
    <div class="add-tab-content">
                ...
                <?php if( $hide_add_prop_fields['land_area'] != 1 ) { ?>
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <input type="text" id="prop_land_area_prefix" <?php if( $area_prefix_changeable != 1 ){ echo 'readonly'; }?> class="form-control" name="prop_land_area_prefix" value="<?php if( isset( $prop_meta_data['fave_property_land_postfix'] ) ) { echo sanitize_text_field( $prop_meta_data['fave_property_land_postfix'][0] ); } ?>">
                        </div>
                    </div>
                <?php } ?>
        ...
        <!-- Additional Features -->
        <?php if( $fave_additional_features_enable != 0 ) { ?>
